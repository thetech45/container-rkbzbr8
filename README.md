...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rkbzbr8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rkbzbr8.containers.anotherwebservice.com/
...
```
git clone git@github.com:thetech45/container-rkbzbr8.git
cd container-rkbzbr8
```
...
```
docker attach container-rkbzbr8
```
